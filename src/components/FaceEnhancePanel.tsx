...
export const FaceEnhancePanel: React.FC<FaceEnhancePanelProps> = ({ onBack, image, onApply }) => {
    ...
    const handleApplyEnhance = async () => {
        ...
        try {
            ...
            const prompt = `Enhance the facial details in this image to make them significantly sharper and clearer. Intensity: ${intensityDesc}. Focus on defining the eyes, lips, and skin texture while strictly preserving the original facial features, identity, and expression. Do not alter the facial structure. The result should be a crisp, high-definition portrait.`;
