...
export const HeadshotScreen: React.FC<{ onBack: () => void; onEdit: (imageUrl: string) => void; }> = ({ onBack, onEdit }) => {
    ...
    const handleProcess = async (imageUrl: string) => {
        ...
        try {
            ...
            // Prompt reforçado para grupos
            const prompt = "Transforme esta foto em headshots corporativos profissionais para TODAS as pessoas visíveis na imagem, seja uma única pessoa ou um grupo. Cada pessoa detectada deve ser vestida com um terno de negócios ou blazer profissional. O fundo deve ser um cenário de escritório neutro e desfocado ou um fundo de estúdio simples. A iluminação deve ser suave e profissional (LinkedIn style). É CRUCIAL manter as características faciais exatas de CADA pessoa detectada na imagem. Não deixe ninguém de fora.";
        ...
        <div className="flex flex-col h-screen bg-[#1F1F1F] text-white overflow-hidden">
            ...
            <header className="flex-shrink-0 z-10 p-4">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="font-semibold text-lg drop-shadow-md">Headshot com IA</h1>
                </div>
            </header>
                ...
                {isProcessing ? (
                    ...
                    <div className="text-center max-w-2xl">
                       <User size={48} className="mx-auto text-blue-400 mb-4"/>
                        ...
                        <p className="text-gray-400 mb-6">Crie headshots profissionais a partir de fotos casuais em segundos. Funciona para fotos individuais e em grupo.</p>
