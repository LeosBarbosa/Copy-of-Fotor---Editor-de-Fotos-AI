...
import { ArrowLeft, Check, Upload, Download, RefreshCw, Sliders, Palette, Paintbrush, Users, Plus, X, UserPlus, Save, Trash2, AlertCircle, CheckSquare, Square, Image as ImageIcon } from 'lucide-react';
    ...
    const handleGenerateClick = async () => {
        ...
        if (selectedStyle === 'custom') {
            ...
            if (sceneToUse && uploadedImage) {
                ...
                styleInstruction = `
                    PERFORM A FACE SWAP / IDENTITY INSERTION.
                    
                    INPUTS:
                    1. MAIN IMAGE (Provided as base): A scene with Stitch and a human.
                    2. REFERENCE IMAGE (Provided as additional): A photo of a user.
                    
                    INSTRUCTION:
                    - Look at the human subject in the MAIN IMAGE.
                    - REPLACE the face/head of that human subject with the face from the REFERENCE IMAGE.
                    - ADJUST skin tone and lighting of the new face to match the MAIN IMAGE scene perfectly.
                    
                    CRITICAL CONSTRAINTS:
                    - DO NOT CHANGE THE BACKGROUND.
                    - DO NOT CHANGE STITCH (The blue alien).
                    - DO NOT CHANGE THE POSE or CLOTHING of the subject in the MAIN IMAGE.
                    - ONLY SWAP THE IDENTITY (Face).
                `;
            } else {
        ...
        await generate(finalPrompt, { 
            ...
            imageOverride: imageOverride // Passa a imagem de override se houver (Stitch)
        });
    };
