...
export const PortraitScreen: React.FC<{ onBack: () => void; initialImage?: string | null }> = ({ onBack, initialImage }) => {
    ...
    const handleGenerateClick = async () => {
        ...
        // Estilo Crosshatch exige o modelo Pro para qualidade extrema
        if (selectedStyle === 'crosshatch') model = 'gemini-3-pro-image-preview';
                        ...
                        <div className="space-y-6">
                            <div className="bg-[#1a1c20] p-6 rounded-2xl border border-gray-800 shadow-xl">
                                ...
                                <div className="space-y-4">
                                    <p className="text-xs text-gray-500">Este estilo utiliza o modelo <strong>Gemini 3 Pro</strong> para máxima fidelidade artística e preservação de identidade.</p>
                                </div>
                            </div>
                        </div>
