...
const sampleImages = [
    { name: 'Exemplo 1', url: 'https://storage.googleapis.com/aistudio-project-files/89c17245-0925-4632-a550-985c7d2429a3/78b9e697-3f81-4321-8255-a0c0b1351d18' },
    { name: 'Exemplo 2', url: 'https://storage.googleapis.com/aistudio-project-files/89c17245-0925-4632-a550-985c7d2429a3/45500d0f-48e8-4623-8686-22a84e62a937' },
];
...
export const WatermarkRemoverScreen: React.FC<{ onBack: () => void; onEdit: (imageUrl: string) => void; }> = ({ onBack, onEdit }) => {
    ...
    const handleProcess = async (imageUrl: string) => {
        ...
        try {
            ...
            const prompt = "Remova quaisquer marcas d'água, logotipos ou sobreposições de texto desta imagem. Reconstrua a área subjacente da forma mais precisa possível para que corresponda ao restante da imagem. A imagem final deve estar limpa e livre de quaisquer artefatos da remoção.";
    ...
    const handleDownload = () => {
        ...
        link.download = `sem-marca-dagua-${Date.now()}.jpg`;
        ...
        <div className="flex flex-col h-screen bg-[#1F1F1F] text-white overflow-hidden">
            ...
            <header className="flex-shrink-0 z-10 p-4">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="font-semibold text-lg drop-shadow-md">Removedor de Marca D'água IA</h1>
                </div>
            </header>
            ...
            <main className="flex-1 min-h-0 flex flex-col items-center justify-center p-4">
                {isProcessing ? (
                    <div className="flex flex-col items-center justify-center text-center p-4">
                        ...
                        <h3 className="text-white font-semibold text-lg">Removendo marca d'água...</h3>
                    ...
                    <div className="text-center max-w-2xl">
                        ...
                        <h2 className="text-3xl font-bold mb-2">Removedor de Marca D'água IA</h2>
                        <p className="text-gray-400 mb-6">Remova logotipos e texto de suas imagens com um clique.</p>
