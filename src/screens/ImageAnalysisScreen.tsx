...
import { AI_TEXT_MODEL } from '../config/constants';
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const suggestionsResponse = await ai.models.generateContent({
        model: AI_TEXT_MODEL,
        contents: { parts: [{ text: `Based on this analysis: "${analysisText}", generate 3 creative and transformative AI editing prompts to improve or radically change this image. Examples: "Turn this into a cyberpunk scene", "Apply a watercolor effect". Format as a simple list starting with dashes.` }] },
      });
